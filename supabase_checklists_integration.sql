...
ALTER TABLE checklist_items ADD COLUMN IF NOT EXISTS inventory_id TEXT; -- Связь с cable_inventory
...
ALTER TABLE checklist_items ADD COLUMN IF NOT EXISTS kit_id TEXT; -- ID комплекта/кофра (если в кофре)
...
CREATE TABLE IF NOT EXISTS kit_items (
    ...
    inventory_id TEXT REFERENCES cable_inventory(id) ON DELETE CASCADE,
